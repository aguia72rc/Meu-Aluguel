...
import { PROPRIETARIO_NOME } from "../lib/receipts";
    ...
    <div className="space-y-6 max-w-lg">
      <div>
        ...
        <p className="text-sm text-ink-muted mt-0.5">
          Nome usado como "Locador(a)" em todos os recibos emitidos.
        </p>
      </div>
      ...
      <div className="card p-6">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-medium text-ink truncate">{PROPRIETARIO_NOME}</p>
